...
export const updateProfile = async (req, res) => {
    try {
        ...
        console.log("✅ ProfilePic received, length:", profilePic.length);
        console.log("ProfilePic starts with:", profilePic.substring(0, 50) + "...");
        console.log("🔄 Uploading to Cloudinary...");

        const uploadResponse = await cloudinary.uploader.upload(profilePic, {
            resource_type: "auto", // This helps Cloudinary detect the file type
            folder: "profile_pics", // Optional: organize uploads in folders
        }); //this function is to upload the profile pic provided to cloudinary.
        ...
        // Better error handling for Cloudinary issues

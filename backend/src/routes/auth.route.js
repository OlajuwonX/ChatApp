...
router.get("/check", protectRoute, checkAuth); // this is to check if the user is authenticated or not. the checkAuth function is called only if user is authenticated.

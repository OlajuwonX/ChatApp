...
const Navbar = () => {
    const {logout, authUser} = useAuthStore(); //from the useAuthStore.

    return (
        <header className="border-b border-base-300 relative w-full top-0 z-40 backdrop-blur-lg bg-base-100/80">

                        ...
                        <div className="bg-base-100 rounded-xl shadow-sm overflow-hidden">
                            ...
                            <div className="px-4 py-3 border-b border-base-300 bg-base-100">
                                <div className="flex items-center gap-3">
                                    <div
                                        className="size-8 rounded-full bg-primary flex items-center justify-center text-primary-content font-medium">
                                        B
                                    </div>
                                    <div>
                                        <h3 className="font-medium text-sm">Bola Tinubu</h3>
                            ...
                            <div className="p-4 space-y-4 min-h-[200px] max-h-[200px] overflow-y-auto bg-base-100">
                                {PREVIEW_MESSAGES.map((message) => (
                                    ...
                                    >
                                        <div
                                            className={`max-h-[80%] rounded-xl p-3 shadow-sm ${message.isSent ? "bg-primary" +
                                                " text-primary-content" : "bg-base-200"}`}>
